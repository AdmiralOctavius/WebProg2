                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="gallery-heading hidden-xs color-bg" style="width: 50%; float:right;">
                            <h2 class="section-title" id="handKilled">Our Feature Sandwiches, handmade, <br>hand killed.</h2>
                        </div>
